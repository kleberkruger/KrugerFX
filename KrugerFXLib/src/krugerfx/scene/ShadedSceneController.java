 ...
 * @author in-sideFX
 */
public class ShadedSceneController {
...
//    }
//
//    public ShadedSceneController(ShadedScene ss) {
//        undecorator = ss;
//    }
//
//    /**
...
//            if (isRightEdge(x1, y1, boundsInParent)) {
//                if (y1 < RESIZE_PADDING + SHADOW_WIDTH) {
//                    setCursor(node, Cursor.NE_RESIZE);
//                } else if (y1 > boundsInParent.getHeight() - (double) (RESIZE_PADDING + SHADOW_WIDTH)) {
//                    setCursor(node, Cursor.SE_RESIZE);
//                } else {
//                    setCursor(node, Cursor.E_RESIZE);
//                }
//            } else if (isLeftEdge(x1, y1, boundsInParent)) {
//                if (y1 < RESIZE_PADDING + SHADOW_WIDTH) {
...
//                }
//            } else if (isTopEdge(x1, y1, boundsInParent)) {
//                setCursor(node, Cursor.N_RESIZE);
//            } else if (isBottomEdge(x1, y1, boundsInParent)) {
...
//
//    /**
//     * Under Windows, the undecorator Stage could be been dragged below the Task bar and then no way
//     * to grab it again... On Mac, do not drag above the menu bar
//     *
//     * @param y
//     */
...
//            }
//        } catch (Exception e) {
//            System.err.println("setStageY issue: " + e);
//        }
//    }
//
